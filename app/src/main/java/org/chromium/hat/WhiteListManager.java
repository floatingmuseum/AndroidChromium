...
//    private final List<String> chromeDefaultUrl;
//
//    private WhiteListManager() {
//        chromeDefaultUrl = new ArrayList<>();
//        chromeDefaultUrl.add("chrome-native://newtab/");
//        chromeDefaultUrl.add("chrome-native://recent-tabs/");
//        chromeDefaultUrl.add("chrome://history/");
//        chromeDefaultUrl.add("chrome://credits");
//        chromeDefaultUrl.add("chrome://history/");
//        chromeDefaultUrl.add("chrome://history/");
//        chromeDefaultUrl.add("chrome://history/");
//        chromeDefaultUrl.add("chrome://history/");
...
//        //一些Chrome的自定义标签页
//        if (chromeDefaultUrl.contains(url)) {
//            return true;
//        }
//
